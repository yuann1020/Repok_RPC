...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const NAV_ITEMS = [
    ...
    { href: '/admin/analytics',     label: 'Analytics',      icon: (<svg width="14" height="14" viewBox="0 0 16 16" fill="none"><path d="M1 14h14M3 10v4M8 5v9M13 2v12" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round" strokeLinejoin="round"/></svg>) },
